...
void debug_status_bar_refresh()
{
    ...
    for(int i= 0; i<7; i++ )
    {
        temp_pc += csg65ce02_dasm(temp_pc, help_string, 256);
        debug_status_bar_print(help_string);
        debug_status_bar_putchar('\n');
    }
    // timer ic information
    snprintf(help_string, 256, "%6llu %6llu", computer.timer_ic->get_timer0_counter(), computer.timer_ic->get_timer0_clock_interval());
    debug_status_bar_set_cursor_pos(579);
    debug_status_bar_print(help_string);
    snprintf(help_string, 256, "%6llu %6llu", computer.timer_ic->get_timer1_counter(), computer.timer_ic->get_timer1_clock_interval());
    debug_status_bar_set_cursor_pos(643);
    debug_status_bar_print(help_string);
    snprintf(help_string, 256, "%6llu %6llu", computer.timer_ic->get_timer2_counter(), computer.timer_ic->get_timer2_clock_interval());
    debug_status_bar_set_cursor_pos(707);
    debug_status_bar_print(help_string);
    snprintf(help_string, 256, "%6llu %6llu", computer.timer_ic->get_timer3_counter(), computer.timer_ic->get_timer3_clock_interval());
    ...
    snprintf(help_string, 256, "       cpu internal status       ");
    ...
    snprintf(help_string, 256, "cpu cycles");
    debug_status_bar_set_cursor_pos(256);
    debug_status_bar_print(help_string);

    snprintf(help_string, 256, "  cpu pins  ");
    ...
    snprintf(help_string, 256, "    timer_ic    \n 0 \n 1 \n 2 \n 3 ");
